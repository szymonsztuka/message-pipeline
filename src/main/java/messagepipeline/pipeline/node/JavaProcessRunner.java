...
public class JavaProcessRunner extends UniversalNode implements Runnable {
    ...
    public JavaProcessRunner(String name, String classpath, String[] jvmArguments, String mainClass, String[] programArguments, String processLogFile, CyclicBarrier batchStart, CyclicBarrier batchEnd) {
        super(name,".",batchStart, batchEnd);
        this.classpath = classpath;
        this.jvmArguments = jvmArguments;
        String[] extended = new String[programArguments.length+1];
        for(int i=0; i <programArguments.length; i++) {
            extended[i] = programArguments[i];
        }
        this.programArguments = extended;
    ...
    public void run() {
        ...
        while(process) {
            ...
            try {
                programArguments[programArguments.length-1]=path.toString();
