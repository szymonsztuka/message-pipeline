...
public class RemoteShellScripTask implements Runnable {
  ...
  public RemoteShellScripTask(String user, String host, String password, String sudo_pass, List<String> files, CyclicBarrier barrier, ShellScriptGenerator shellScriptGenerator) {
      this.user=user;
      this.host=host;
